...
lazy val SLFromHomeToHere   = "sbt/test/002_expression"

// Respective source roots for the test, of Scart settings, and User project
lazy val SLDoubletSrcRoot   = ("test/002_expression/scart", "test/002_expression/main")
